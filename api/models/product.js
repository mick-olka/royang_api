...
const productSchema = mongoose.Schema({
    ...
    relatedProducts: [{type: mongoose.Schema.Types.ObjectId, ref: 'Product', unique: false}],
    similarProducts: [{type: mongoose.Schema.Types.ObjectId, ref: 'Product', unique: false}],
    types: [],
